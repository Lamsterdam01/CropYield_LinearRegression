...
Los resultados del análisis estadístico realizado ofrecen una visión detallada de los factores que impactan la productividad agrícola a nivel global. Comenzando con la exploración inicial, no se identificaron datos faltantes en el conjunto de datos, lo que asegura la confiabilidad y consistencia del análisis. Esto permitió trabajar directamente con la totalidad de las observaciones, eliminando la necesidad de imputar valores que podrían introducir sesgos.
La distribución de la productividad agrícola mostró una asimetría positiva, donde la mayoría de los cultivos se encuentran en un rango de bajo rendimiento, mientras que un número reducido logra alcanzar rendimientos altos. Este patrón resalta la necesidad de investigar los factores asociados a estos cultivos de alto rendimiento, como estrategias específicas de manejo o condiciones ambientales favorables. En paralelo, los histogramas de temperatura promedio y precipitación total revelaron una bimodalidad y una variabilidad significativa, respectivamente. Estos resultados son consistentes con la diversidad climática de las regiones analizadas, desde zonas templadas hasta tropicales, y destacan la relevancia de ambos factores en el desempeño agrícola.
El análisis de las variables categóricas mostró una representación equilibrada entre países, regiones y tipos de cultivos, lo que refuerza la aplicabilidad global de los resultados. Entre las estrategias de adaptación, la gestión del agua y la rotación de cultivos emergieron como las más comunes, lo que refleja la prioridad en manejar eficientemente los recursos hídricos y preservar la fertilidad del suelo frente a los desafíos climáticos.
En términos de relaciones entre variables, los gráficos de dispersión y la matriz de correlación destacaron conexiones clave, como la relación positiva entre temperaturas moderadas y productividad agrícola, con una disminución del rendimiento en climas más extremos. La precipitación también mostró una relación no lineal, donde valores demasiado bajos o excesivamente altos impactaron negativamente el rendimiento, subrayando la importancia de un balance hídrico adecuado.
El modelado estadístico identificó al modelo reducido con enlace logarítmico como el más eficiente. Este modelo utilizó la temperatura promedio, la precipitación y el tipo de cultivo como predictores principales, logrando un equilibrio ideal entre precisión y simplicidad. Las métricas de bondad de ajuste y el análisis de residuos confirmaron la validez de los supuestos teóricos del modelo, aunque se identificaron algunos patrones residuales que sugieren un rellenado de la base de datos con la media ponderada.
Finalmente, la eliminación de valores atípicos permitió refinar los modelos ajustados, asegurando que las observaciones extremas no distorsionaran los resultados. La comparación de modelos basada en AIC, BIC y pseudo R² confirmó que el modelo reducido con enlace logarítmico no solo era estadísticamente robusto, sino también práctico para predecir la productividad agrícola en diversos contextos climáticos y geográficos. Estos hallazgos refuerzan la necesidad de estrategias agrícolas adaptativas que consideren la diversidad de factores climáticos y su interacción con las prácticas agrícolas.
...
En resumen, este proyecto valida el uso de modelos estadísticos para identificar y cuantificar los efectos del clima en la productividad agrícola, ofreciendo insights valiosos para un futuro más resiliente en la seguridad alimentaria.
